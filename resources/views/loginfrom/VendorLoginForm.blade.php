...
@section('content')
    ...
    <section class="quotation-section my-40">
        <div class="container-fluid">
            <h2 class="heading-1 py-4">VENDOR LOGIN FORM</h2>
                ...
                <div class="col-lg-12 d-flex align-content-center">
                    <div class="bg-white h-100 px-40 py-50">
                        ...
                        <form action="{{route('vendor-login')}}" method="post">
                        	@csrf
                            <h4 class="mb-5 text-center" style="font-weight: 900"><a href="{{route('VendorLoginForm')}}" style="color: #1696e7;">VENDOR LOGIN FORM | </a> <a href="{{route('ImporterLoginForm')}}">IMPORTER LOGIN FORM | </a> <a href="{{route('MerchantLoginForm')}}">MERCHANT LOGIN FORM | </a></h4>

                            <h2 class="mb-5 text-center"  style="color: #1696e7;">VENDOR LOGIN FORM</h2>
                            <div class="row">
