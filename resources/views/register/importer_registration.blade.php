...
@section('content')
    ...
    <section class="quotation-section my-40">
        <div class="container-fluid">
            <h2 class="heading-1 py-4">IMPORTER REGISTRATION</h2>
            ...
            <div class="row">
                ...
                <div class="col-lg-12 d-flex align-content-center">
                    <div class="bg-white h-100 px-40 py-50">
                        ...
                        <form action="{{route('importer-registration')}}" method="post">
                            @csrf
                            <h4 class="mb-5 text-center" style="font-weight: 900"><a href="{{route('vendor-registration')}}">ARE YOU A VENDOR ??</a> <a href="{{route('importer-registration')}}"  style="color: #1696e7;">ARE YOU AN IMPORTER ??</a> <a href="{{route('merchant-registration')}}">ARE YOU A MERCHANT ??</a></h4>

                            <h2 class="mb-5 text-center">IMPORTER REGISTRATION</h2>
                            <div class="row">
                                <div class="col-6">
