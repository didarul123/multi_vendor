                                ...
                                <div class="d-table-cell">
                                    <!-- Buy Now button -->
                            			...
                            			<form action="{{route('add-to-cart')}}" method="post">
                                        	...
                                        	<button type="submit" class="btn btn-success btn-styled fz-small btn-alt-base-1 c-white btn-icon-left strong-700 hov-bounce hov-shaddow ml-2 add-to-cart" style="position: relative;left: 133px; bottom: 43px;">
