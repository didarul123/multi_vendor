...
<!--                     <td>{{$product->subcategory->name ?? ''}}</td>
	                ...
	                <td>
                      ...
                      <div class="row">
                          <a href="{{URL::to('importer/product/'.$product->id.'/edit')}}" title="Edit" style="float: left; margin-left: 10px; margin-right: 10px">
                              <button type="submit" class="btn btn-primary btn-sm"><i class="fa fa-edit"></i>
                              </button>
                          </a>

                          <form action="{{URL::to('importer/product/'.$product->id)}}" method="post">
                            @csrf
                            @method('DELETE')
