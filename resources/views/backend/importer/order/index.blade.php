                ...
                <tr>
                  ...
                  <td>
                    ...
                    <td>
                      ...
                      <div class="row">
                        <a href="{{URL::to('importer/order/'.$order->order_id)}}" title="View" style="float: left;margin-right: 10px;">
                            <button type="submit" class="btn btn-primary btn-sm"><i class="fa fa-eye"></i>
                            </button>
                        </a>                        

                        <a href="{{URL::to('importer/order/'.$order->order_id.'/edit')}}" title="Edit" style="float: left;margin-right: 10px;">
