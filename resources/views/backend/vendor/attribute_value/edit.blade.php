          	...
          	<div class="col-md-4 mt-5">
	            ...
	            <!-- Horizontal Form -->
		            <div class="card card-info">
		              ...
		              <!-- /.card-header -->
		              <!-- form start -->
		              <form class="form-horizontal" action="{{URL::to('vendor/attribute_value/'.$attribute_value->id)}}" method="post" enctype="multipart/form-data">
		              	@csrf
		              	@method('PATCH')
		                <div class="card-body">
					                ...
					                <tr>
						                ...
						                <td>
					                      ...
					                      <div class="row">
					                        ...
					                        <a href="{{URL::to('vendor/attribute_value/'.$attribute_value->id.'/edit')}}" title="Edit" style="float: left;margin-right: 10px;">
					                            <button type="submit" class="btn btn-primary btn-sm"><i class="fa fa-edit"></i>
					                            </button>
					                        </a>

<!-- 					                        <form action="{{URL::to('vendor/attribute_value/'.$attribute_value->id)}}" method="post" style="float: left;margin-right: 10px;">
					                          @csrf
					                          @method('DELETE')
