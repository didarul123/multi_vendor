        ...
        <div class="container-fluid">
            ...
            <div class="row m-0">
                ...
                <div class="col-6 col-md-4 col-lg-3 mb-3 px-2">
                    <a href="{{URL::to('vendor/shop/'.$product->id)}}" class="text-black">
                        <div class="bg-white hover-shadow rounded p-3 product-card">
                            <img src="{{ asset($product->image) }}" alt="{{$product->name}}">
                            <a href="{{URL::to('vendor/shop/'.$product->id)}}" class="fz-small hover-underline mb-4 text-black d-inline-block" style="font-size: 20px; font-weight: 700;">{{$product->name}}</a>
