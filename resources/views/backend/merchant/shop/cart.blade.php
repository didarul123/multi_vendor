    ...
    <div id="page">
      <table id="cart">
        ...
        <tbody>
          ...
          <form action="{{URL::to('merchant/update-cart')}}">
            @csrf
          ...
          <tr class="productitm">
            ...
            <td>{{$content->price}} /-</td>
            <td><a href="{{ route('merchant/remove-from-cart',[$content->rowId])}}"><span class="remove"><img src="https://i.imgur.com/h1ldGRr.png" alt="X"></span></a></td>
          </tr>
          <?php }?>
...
<!--           <tr class="extracosts">
          ...
          <tr class="checkoutrow">
            ...
            <form action="{{URL::to('merchant/checkout')}}" method="get" class="d-inline-block">
                @csrf
