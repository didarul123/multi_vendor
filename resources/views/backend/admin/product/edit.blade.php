		                  	...
		                  	<div class="form-group row">
			                    ...
			                    <div class="col-sm-4">
			                    	<label for="inputEmail3" class=" col-form-label">Min Order Qty</label>
			                      	<input type="number" class="form-control" name="min_order_qty" required="" value="{{$product->min_order_qty}}">
			                    </div> 

			                    <div class="col-sm-4">
			                    	<label for="inputEmail3" class=" col-form-label">Max Order Qty</label>
			                      	<input type="number" class="form-control" name="max_order_qty" required="" value="{{$product->max_order_qty}}">
			                    </div> 
		                  	</div>
