  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="text-center">{{$merchant->name ?? ''}} s'Profile</h1>
          </div>
          <div class="col-sm-6">
              ...
              <div class="card-body box-profile">
                ...
                <ul class="list-group list-group-unbordered mb-3">
                  <li class="list-group-item">
                    <b>Id</b> <a class="float-right"># {{$merchant->id ?? ''}}</a>
                  </li>                  
                  <li class="list-group-item">
                    <b>Email</b> <a class="float-right">{{$merchant->email ?? ''}}</a>
                  </li>
                  <li class="list-group-item">
                    <b>Phone</b> <a class="float-right">{{$merchant->phone ?? ''}}</a>
                  </li>
                  <li class="list-group-item">
                    <b>Company</b> <a class="float-right">{{$merchant->company ?? ''}}</a>
                  </li>                  
                  <li class="list-group-item">
