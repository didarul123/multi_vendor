...
class AttributeController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('backend.vendor.attribute.index', compact('attributes'));
    }
    ...
    {
        return view('backend.vendor.attribute.create');
    }
    ...
    public function edit($id)
    {
        ...
        return view('backend.vendor.attribute.edit', compact('attribute'));
    }
