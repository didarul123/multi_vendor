...
class ShopController extends Controller
{
    ...
    public function index()
    {
        ...
        $products = Product::where('importer_id', "!=", '')->orWhere('merchant_id', "!=", '')->simplepaginate(20);

        return view('backend.vendor.shop.products', compact('products'));
    }
    ...
    public function store(Request $request)
    {
        ...
        // print_r($cart);
        // echo "</pre>";
         return view('backend.vendor.shop.cart'); 
    }
    ...
    public function show($id)
    {
        ...
        return view('backend.vendor.shop.product_details', compact('product', 'product_images', 'product_categories', 'product_attributes', 'vendor', 'shop', 'attributes', 'product_variations', 'top_sell'));
    }
    ...
    public function checkout(){
        ...
        return view('backend.vendor.shop.checkout', compact('shop', 'shop_owner'));
    }
    ...
    public function total_amount(Request $request){
        ...
        return view('backend.vendor.shop.total_amount', compact('paymentMethods', 'admin', 'f_name', 'l_name', 'number', 'shipping_address', 'city', 'postcode', 'country', 'shop', 'shop_owner'));
    }
    ...
    public function order_history()
    {
        ...
        return view('backend.vendor.order.order_history', compact('orders'));
    }
