...
class ShopController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('backend.merchant.shop.products', compact('products'));
    }
    ...
    public function show($id)
    {
        ...
        return view('backend.merchant.shop.product_details', compact('product', 'product_images', 'product_categories', 'product_attributes', 'vendor', 'shop', 'attributes', 'product_variations', 'top_sell'));
    }
    ...
    public function show_cart(){
        return view('backend.merchant.shop.cart'); 
    }
    ...
    public function checkout(){
        ...
        return view('backend.merchant.shop.checkout', compact('shop', 'shop_owner'));
    }
    ...
    public function total_amount(Request $request){
        ...
        return view('backend.merchant.shop.total_amount', compact('paymentMethods', 'admin', 'f_name', 'l_name', 'number', 'shipping_address', 'city', 'postcode', 'country', 'shop', 'shop_owner'));
    }
    ...
    public function order_history()
    {
        ...
        return view('backend.merchant.order.order_history', compact('orders'));
    }
