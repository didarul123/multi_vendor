...
class AttributeValueController extends Controller
{
    ...
    public function index()
    {
        ...
        $attributes = Attribute::where('merchant_id', $user_id)->get();
        $attribute_values = Attribute_value::where('merchant_id', $user_id)->get();
        return view('backend.merchant.attribute_value.index', compact('attributes', 'attribute_values'));
    }
    ...
    public function edit($id)
    {
        ...
        $attributes = Attribute::where('merchant_id', $user_id)->get();
        $attribute_values = Attribute_value::where('merchant_id', $user_id)->get();
        return view('backend.merchant.attribute_value.edit', compact('attribute_value', 'attributes', 'attribute_values'));
    }
