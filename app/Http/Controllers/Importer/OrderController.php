...
class OrderController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('backend.importer.order.index', compact('orders', 'methods', 'user_id', 'user_type'));
    }
    ...
    public function show($order_id)
    {
        ...
        return view('backend.importer.order.details', compact('order', 'orderDetails', 'toal_p_price','tax', 'shipping_charge', 'total'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('backend.importer.order.edit', compact('order', 'orderDetails', 'shop', 'shop_owner', 'toal_p_price', 'total_qty'));
    }
   ...
   public function filter_order(Request $request){
        ...
        return view('backend.importer.order.filter_order',compact('orders','from_date', 'to_date', 'payment_method', 'status', 'today_date', 'methods', 'user_id', 'user_type'));
   }
    ...
    public function invoice_print($id){
        ...
        $shipping_charge = 100;
        $total = $toal_p_price + $tax + $shipping_charge;
        return view('backend.importer.order.invoice_print', compact('order', 'orderDetails', 'toal_p_price','tax', 'shipping_charge', 'total'));
    }
