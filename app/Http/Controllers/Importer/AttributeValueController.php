...
class AttributeValueController extends Controller
{
    ...
    public function index()
    {
        ...
        $attribute_values = Attribute_value::where('importer_id', $user_id)->get();
        return view('backend.importer.attribute_value.index', compact('attributes', 'attribute_values'));
    }
    ...
    public function edit($id)
    {
        ...
        $attributes = Attribute::where('importer_id', $user_id)->get();
        $attribute_values = Attribute_value::where('importer_id', $user_id)->get();
        return view('backend.importer.attribute_value.edit', compact('attribute_value', 'attributes', 'attribute_values'));
    }
